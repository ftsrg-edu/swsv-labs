...
%TODO or 12pt? or use a5paper?
\documentclass[10pt,ebook,oneside]{memoir}
...
\include{content/critical-systems}
...
\include{content/static-specification}
\include{content/static-code}

\part{Dynamic Techniques}

\include{content/testing-overview}
\include{content/development-testing}
\include{content/test-design-specification}
\include{content/test-design-structure}
\include{content/test-process-levels}
\include{content/test-automation}
